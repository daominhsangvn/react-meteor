...
var DDP = function (_EventEmitter) {
    ...
    (0, _createClass3.default)(DDP, [{
        ...
        value: function emit() {
            ...
            setTimeout((_get2 = (0, _get4.default)(DDP.prototype.__proto__ || (0, _getPrototypeOf2.default)(DDP.prototype), "emit", this)).bind.apply(_get2, [this].concat(Array.prototype.slice.call(arguments))), 0);
        }
    }]);
    ...
    function DDP(options) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (DDP.__proto__ || (0, _getPrototypeOf2.default)(DDP)).call(this));
